package com.cjl.basci.zone.common.constant;
...
public class UserConstants {
     ...
     * reserPwd 是否唯一的返回结果
     */
    public final static String USER_RESETAWD_UNIQUE = "0";
    public final static String USER_RESETAWD_NOT_UNIQUE = "1";

    /**
     * 菜单显示隐藏
     */
    public final static String MENU_VISIBLE_SHOW = "0";
    public final static String MENU_VISIBLE_HIDE = "1";
}
