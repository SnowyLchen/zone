...
import com.cjl.basci.zone.framework.shiro.jwt.StatelessToken;
import com.cjl.basci.zone.framework.shiro.jwt.filter.StatelessFilter;
import com.cjl.basci.zone.framework.shiro.jwt.subject.StatelessWebSubjectFactory;
import com.cjl.basci.zone.framework.shiro.realm.StatelessRealm;
import com.cjl.basci.zone.framework.shiro.web.filter.StatelessLogoutFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/ztt/**", "anon");
        // 不需要拦截的访问
        ...
        filterChainDefinitionMap.put("/skipResetPwd/first", "anon");
        filterChainDefinitionMap.put("/skipResetPwd/second", "anon");
        filterChainDefinitionMap.put("/skipResetPwd/third", "anon");
        filterChainDefinitionMap.put("/resetPaw", "anon");
        filterChainDefinitionMap.put("/register", "anon");
        filterChainDefinitionMap.put("/statement", "anon");
        filterChainDefinitionMap.put("/checkLoginNameUnique", "anon");
        filterChainDefinitionMap.put("/checkPhoneUnique", "anon");
        filterChainDefinitionMap.put("/sms/verification/**", "anon");
        filterChainDefinitionMap.put("/checkMobileUnique", "anon");
        filterChainDefinitionMap.put("/mfrsWithZht/**/*", "anon");
        filterChainDefinitionMap.put("/mfrssyszgmenu/*/**", "anon");
        // 系统权限列表
