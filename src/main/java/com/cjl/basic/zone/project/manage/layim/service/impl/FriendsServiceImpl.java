...
import com.cjl.basic.zone.project.manage.layim.mapper.FriendsMapper;
import com.cjl.basic.zone.project.manage.layim.mapper.SysMsgMapper;
...
public class FriendsServiceImpl implements FriendsService {
    ...
    @Override
    public Friends createGroup(Friends friends) {
        friendsMapper.createGroup(friends);
        return friends;
    }

    @Override
    public int removeFriendGroup(Integer id) {
        return friendsMapper.removeFriendGroup(id);
    }
