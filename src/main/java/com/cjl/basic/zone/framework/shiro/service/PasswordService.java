...
//
//import com.cjl.basci.zone.common.utils.SpringRedisUtil;
...
//import com.uustop.common.utils.SpringRedisUtil;
...
//            AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, user.getMfrsId() + "", Constants.LOGIN_FAIL, MessageUtils.message("user.password.retry.limit.exceed", maxRetryCount)));
//            throw new UserPasswordRetryLimitExceedException(maxRetryCount);
//        }
//
//        if (!matches(user, password)) {
//            AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, user.getMfrsId() + "", Constants.LOGIN_FAIL, MessageUtils.message("user.password.retry.limit.count", retryCount)));
